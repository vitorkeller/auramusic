			...
			<div className="mt-6 row-span-3 self-end w-158 h-158 border border-white/10 rounded-t-2xl bg-white/8 backdrop-blur-md shadow-inner shadow-black/30">
				<div className="flex flex-col h-full">
					...
					<div className="flex flex-col self-center">
						...
						<div className="mt-2 flex flex-col gap-3">
							<Button onClick={handleLogin} disabled={loading}>
								{loading ? (
									...
									<span className="text-white font-medium flex justify-center w-full">Entrar</span>
								)}
							</Button>

							<div className="flex justify-center text-sm text-white/40">
								<span>Não tem uma conta? </span>
								<Link href="/register" className="ml-1 hover:text-white transition-colors">
									Cadastre-se
								</Link>
							</div>
						</div>
						...
						<span className="flex justify-center mt-15 px-4 text-white/80 text-md">Aura Music © 2026 </span>
					</div>
				</div>
			</div>
		</div>
